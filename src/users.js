    ...
    <div style="font-family:'Segoe UI',Arial,sans-serif;background:#f4f4f4;padding:32px;">
      <div style="max-width:480px;margin:auto;background:#fff;border-radius:12px;box-shadow:0 2px 12px #0001;padding:32px 24px;">
        <div style="text-align:center;">
          ...
          <a href="https://fun.szabee.me" style="display:inline-block;background:#007BFF;color:#fff;text-decoration:none;padding:12px 28px;border-radius:8px;font-weight:bold;margin-bottom:24px;">Go to Homepage</a>
          <hr style="margin:32px 0;border:none;border-top:1px solid #eee;">
          <p style="color:#555;font-size:0.95em;">
            You can always check our <a href="https://fun.szabee.me/privacy-policy" style="color:#007BFF;">Privacy Policy</a>.<br>
